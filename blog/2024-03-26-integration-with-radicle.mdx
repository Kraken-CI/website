...
description is heavily based on the article [Integrating a CI system
using Radicle Webhooks](https://hackmd.io/FnPxhc5ESZKHEJFHdA2x6A).
...
methodologies from: https://radicle.xyz/#try. After the Radicle
