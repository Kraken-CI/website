...
In the case of Radicle, the procedure is more complicated and is
described in a dedicated article: [Integration with Radicle](/blog/integration-with-radicle)
