...
- learn more about Kraken concepts: read [Entities & Terminology](entities.md) and [Architecture](architecture.md) chapters
- start using Kraken by creating new project, branches, etc: see [Usage chapters](proj-branches.mdx)
- install new agents: visit [Agents](agents.mdx) chapter in Administraction category
