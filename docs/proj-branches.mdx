...
<Screen img="screen-projects.png" />
...
<Screen img="screen-branches.png" />
...
<Screen img="screen-branch-mgmt.png" />
...
Coming back to a workflow schema in a branch, it is defined as a set
of stages. More about stages and their schema in the next chapter.
